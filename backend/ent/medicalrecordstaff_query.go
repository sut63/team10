...
//	}
//
//	client.Medicalrecordstaff.Query().
//		GroupBy(medicalrecordstaff.FieldName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.Medicalrecordstaff.Query().
//		Select(medicalrecordstaff.FieldName).
//		Scan(ctx, &v)
//
...
func (mq *MedicalrecordstaffQuery) sqlAll(ctx context.Context) ([]*Medicalrecordstaff, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, medicalrecordstaff.ForeignKeys...)
	}

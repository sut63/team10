...
func (bu *BloodtypeUpdate) SetBloodtype(s string) *BloodtypeUpdate {
	bu.mutation.SetBloodtype(s)
	return bu
}

// AddEdgesOfPatientrecordIDs adds the EdgesOfPatientrecord edge to Patientrecord by ids.
func (bu *BloodtypeUpdate) AddEdgesOfPatientrecordIDs(ids ...int) *BloodtypeUpdate {
	bu.mutation.AddEdgesOfPatientrecordIDs(ids...)
	return bu
}

// AddEdgesOfPatientrecord adds the EdgesOfPatientrecord edges to Patientrecord.
func (bu *BloodtypeUpdate) AddEdgesOfPatientrecord(p ...*Patientrecord) *BloodtypeUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return bu.AddEdgesOfPatientrecordIDs(ids...)
}
...
func (bu *BloodtypeUpdate) RemoveEdgesOfPatientrecordIDs(ids ...int) *BloodtypeUpdate {
	bu.mutation.RemoveEdgesOfPatientrecordIDs(ids...)
	return bu
}

// RemoveEdgesOfPatientrecord removes EdgesOfPatientrecord edges to Patientrecord.
func (bu *BloodtypeUpdate) RemoveEdgesOfPatientrecord(p ...*Patientrecord) *BloodtypeUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return bu.RemoveEdgesOfPatientrecordIDs(ids...)
}
...
func (bu *BloodtypeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := bu.mutation.Bloodtype(); ok {
	...
	if nodes := bu.mutation.RemovedEdgesOfPatientrecordIDs(); len(nodes) > 0 {
	...
	if nodes := bu.mutation.EdgesOfPatientrecordIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   bloodtype.EdgesOfPatientrecordTable,
...
// SetBloodtype sets the bloodtype field.
func (buo *BloodtypeUpdateOne) SetBloodtype(s string) *BloodtypeUpdateOne {
	buo.mutation.SetBloodtype(s)
	return buo
}

// AddEdgesOfPatientrecordIDs adds the EdgesOfPatientrecord edge to Patientrecord by ids.
func (buo *BloodtypeUpdateOne) AddEdgesOfPatientrecordIDs(ids ...int) *BloodtypeUpdateOne {
	buo.mutation.AddEdgesOfPatientrecordIDs(ids...)
	return buo
}

// AddEdgesOfPatientrecord adds the EdgesOfPatientrecord edges to Patientrecord.
func (buo *BloodtypeUpdateOne) AddEdgesOfPatientrecord(p ...*Patientrecord) *BloodtypeUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return buo.AddEdgesOfPatientrecordIDs(ids...)
}
...
// RemoveEdgesOfPatientrecordIDs removes the EdgesOfPatientrecord edge to Patientrecord by ids.
func (buo *BloodtypeUpdateOne) RemoveEdgesOfPatientrecordIDs(ids ...int) *BloodtypeUpdateOne {
	buo.mutation.RemoveEdgesOfPatientrecordIDs(ids...)
	return buo
}

// RemoveEdgesOfPatientrecord removes EdgesOfPatientrecord edges to Patientrecord.
func (buo *BloodtypeUpdateOne) RemoveEdgesOfPatientrecord(p ...*Patientrecord) *BloodtypeUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return buo.RemoveEdgesOfPatientrecordIDs(ids...)
}
...
func (buo *BloodtypeUpdateOne) sqlSave(ctx context.Context) (b *Bloodtype, err error) {
	...
	if value, ok := buo.mutation.Bloodtype(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: bloodtype.FieldBloodtype,
	...
	if nodes := buo.mutation.RemovedEdgesOfPatientrecordIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   bloodtype.EdgesOfPatientrecordTable,
	...
	if nodes := buo.mutation.EdgesOfPatientrecordIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   bloodtype.EdgesOfPatientrecordTable,
